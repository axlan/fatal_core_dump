...
enum SDNMsgType
{
    ...
    SDN_MSG_TYPE_LOG = 8,
    SDN_MSG_TYPE_REQUEST_SUIT_OCCUPANT = 9,
...
typedef struct SDNRequestSuitOccupantMessage SDNRequestSuitOccupantMessage;
struct SDNRequestSuitOccupantMessage
{
    SDNMsgHeader msg_header;
    uint32_t user_id;
};
